          ...
          children: <Widget>[
            DefaultTextStyle.merge(
              ...
              child: ActionSlider.dual(
                ...
                icon: Padding(
                  ...
                  child: Transform.rotate(angle: 0.5 * pi, child: const Icon(Icons.unfold_more_rounded, size: 28.0)),
                ),
            ...
            ActionSlider.custom(
              ...
              outerBackgroundBuilder: (context, state, child) => Card(
                ...
                child: Center(child: Text(state.position.toStringAsFixed(2), style: theme.textTheme.titleMedium)),
              ),
            ...
            ActionSlider.custom(
              ...
              foregroundBuilder: (context, state, child) => child!,
              backgroundChild: Center(child: Text('Highly Customizable :)', style: theme.textTheme.titleMedium)),
